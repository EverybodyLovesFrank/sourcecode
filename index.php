...
<html>
	<head>
		...
		<script type="text/javascript">
			// preloader for Around the Web buttons
			gitb = new Image();
...
<body>
	...
	<?php
	// Deal with the contact form messaging
	...
	<div id="DevilHeader">
		...
		<div id="AroundTheWeb">
			...
			<span id="CloseAroundTheWeb">X</span>
		</div>
	</div>
	...
	<div id="TopModule">
		...
		<p class="body">My name is Frank Pernicano, and I'm really good at leading tech teams in a technical architecture and design capacity. I have hard-core ninja-like development experience with some of the largest companies in the world like Chase, Disney, AAA, and Johnson &amp; Johnson</p>
	</div>
	...
	<script type="text/javascript">
		...
		$("#AroundTheWebOpener").click(function() {
			$("#AroundTheWebOpener").slideUp("slow");
			$("#AroundTheWeb").slideDown("slow");
		});
		$("#CloseAroundTheWeb").click(function() {
			$("#AroundTheWebOpener").slideDown("slow");
			$("#AroundTheWeb").slideUp("slow");
		});
		// end modules
